            ...
            <div class="max-w-5xl mx-auto">
                ...
                <div class="grid sm:grid-cols-2 gap-6 md:gap-12">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-gray-600 dark:text-neutral-400">
                            Protecting the data you trust to Preline is our first priority. This part is really crucial
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-gray-600 dark:text-neutral-400">
                            We've built in discounts at each tier for teams. The time has come to bring those ideas and
                            plans to life.
                        </p>
                    </div>
                    <!-- End Col -->
