<section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
        <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
            <h2 class="mb-4 text-3xl tracking-tight font-extrabold text-gray-900 dark:text-white">Testimoni Pelanggan
            </h2>
            <p class="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">Kata mereka setelah sewa mobil di
                SewaYU yang pernah mereka coba dan rasakan secara langsung</p>
        </div>
        {{-- <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
            <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="p-5">
                    ...
                    <span class="text-gray-500 dark:text-gray-400">Toyota Innova Zenix 2025</span>
                    <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">Mobil sangat nyaman dikendarai, dan sangat terasa masih baru. 
                        Pelayanan yang diberikan juga sangat oke
                    </p>
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="flex h-auto">
                <div class="flex flex-col bg-gray-200 rounded-xl dark:bg-neutral-900">
                    <div class="flex-auto p-4 md:p-6">
                        <p class="text-base italic md:text-lg text-gray-800 dark:text-neutral-200">
                            " With Preline, we're able to easily track our performance in full detail. It's become an
            ...
            <div class="flex h-auto">
                <div class="flex flex-col bg-gray-200 rounded-xl dark:bg-neutral-900">
                    <div class="flex-auto p-4 md:p-6">
                        <p class="text-base italic md:text-lg text-gray-800 dark:text-neutral-200">
                            " In September, I will be using this theme for 2 years. I went through multiple updates and
