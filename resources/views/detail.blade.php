        ...
        <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0">
            <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
                <div class="shrink-0 max-w-md lg:max-w-lg mx-auto">
                    <img class="w-full dark:hidden" src="{{ asset('storage/' . $product->image) }}" alt="" />
                ...
                <div class="mt-6 sm:mt-8 lg:mt-0">
                    ...
                    <div class="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
                        ...
                        <button id="loginButton" data-modal-target="loginModal-{{ $product->id }}"
                            data-modal-toggle="loginModal-{{ $product->id }}"
                        ...
                        <!-- Main modal -->
                        <div id="loginModal-{{ $product->id }}" tabindex="-1" aria-hidden="true"
                            ...
                            <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                ...
                                <div
                                    ...
                                    <svg class="w-11 h-11 mb-3.5 mx-auto text-blue-700 dark:text-white"
                                    ...
                                    <p class="mb-1 text-black dark:text-gray-300">Ingin sewa {{ $product->name }}?</p>
                                    <p class="mb-4 text-sm font-light text-black dark:text-gray-300">Login dulu yuk!
                                        Atau belum punya akun? Klik REGISTER untuk buat akun sekarang!!</p>
                                    <div class="flex justify-center items-center space-x-4 mt-3">
                                        <a href="{{ route('login') }}"">
                                            <button data-modal-toggle="loginModal-{{ $product->id }}" type="submit"
